...
// Read string input from serial monitor
// Convert the serial input to strings, read it one by one letter, and store it into a buffer called input
...
// prompt the user for PID constants, for both q and d axis
